...
| EPG-X | yes | hard_rf, configuration_states, exchange, multi_pool | Two-pool liquid Bloch–McConnell evolution on the 6-row layout, or MT evolution on the 4-row free/bound layout. Declared off-resonance RF events can apply Super-Lorentzian bound-pool absorption; on-resonance Super-Lorentzian and CEST remain closed. |
