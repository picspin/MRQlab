...
describe("Wave A remainder: Explore ↔ recipe identity", () => {
  it("maps executable Explore cards onto backend recipe ids", () => {
    ...
    expect(byId["cest-apt-pulsed"].clinicalQuestion).toMatch(/pulsed/i);
  ...
  it("nav chrome says v0.74.1", () => {
    ...
    expect(screen.getByTestId("version-tag")).toHaveTextContent("v0.74.1");
  });
});
