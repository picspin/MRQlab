...
export function GradientEventEditor({ channel, initialAmplitude, physicalUnits, onApply }: { channel: "Gx" | "Gy" | "Gz"; initialAmplitude: number; physicalUnits?: boolean; onApply?: (patch: { amplitude_mt_m: number; duration_s: number; ramp_time_s: number; unit: "mT_m" }) => Promise<void> }) {
